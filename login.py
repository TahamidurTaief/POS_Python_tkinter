...
class login_system:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed by shaheer")
        ...
        btn_forget=Button(login_frame,text="Forget Password",command=self.forget_win,font=("times new roman",13),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E").place(x=100,y=390)
        
        #=============frame2=============================
        register_frame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        register_frame.place(x=750,y=570,width=350,height=60)
        
        lbl_reg=Label(register_frame,text="Made by |Shaheer",font=("times new roman",13),bg="white").place(x=110,y=20)
            ...
            if self.employee_id.get()=="" or self.password.get()=="":
              ...
              if user==None:
                messagebox.showerror('Error',"Invalid USERNAME/Password",parent=self.root)
                   ...
                   if user[0]=="Admin":
                      self.root.destroy()
                      os.system("python dashboard.pyw")
                   else:
                       self.root.destroy()
                       os.system("python billing.pyw")
              ...
              if email==None:
                  ...
                  if chk=='f':
                      messagebox.showerror("Error","Connection Error,try again",parent=self.root)
                        ...
                        lbl_reset=Label(self.forget_win,text="Enter OTP sent on the Email",font=("times new roman",15)).place(x=20,y=60)
