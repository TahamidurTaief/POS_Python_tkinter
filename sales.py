...
class salesClass:
    def __init__(self,root):
        ...
        btn_logo=Button(self.root,text="Add Logo",command=self.add_logo,font=("times new roman",15,"bold"),bg="lightgrey",cursor="hand2").place(x=600,y=100,width=120,height=28)
...
#==========================================================================
    ...
    def add_logo(self):
        global my_logo
        self.my_logo = PhotoImage(file="images/xpress.png")
        position = self.bill_area.index(INSERT)
        self.bill_area.image_create(position, image=self.my_logo)
        

    def show(self):
        del self.bill_list[:]
        self.Sales_list.delete(0,END)
        # print(os.listdir('../INVENTORY SYSTEM BY SHAHEER'))
